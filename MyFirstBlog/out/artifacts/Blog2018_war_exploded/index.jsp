    ...
    <div style="width: 30%" class="pl-5 pr-5 pb-5 pt-2 border rounded border-light  ">
        ...
        <form  action="/loginServlet" method="post" >
            <div class="form-group">
                <input style="background-color: rgba(61,61,61,0.11);color: whitesmoke" type="text" class="form-control border border-light"name="email" type="text" placeholder="email"">
            </div>
            <br>
            <div class="form-group">
                <input style="background-color: rgba(61,61,61,0.11);color: whitesmoke" type="password" class="form-control border border-light" name="password" type="password" placeholder="password">
            </div>
            <br>
            <div class="d">
